...
/***************************************************************************
 * Drivers for MSPM0L and MSPM0G class of uC from Texas Instruments.
...
{
	for (long unsigned int i = 0; i < ARRAY_SIZE(mspm0_fctl_fail_decode_strings); i++) {
